...
async def k8s_v1_client_fixture(k8s_client: Mock) -> AsyncGenerator[Mock]:  # noqa: ARG001
    ...
    with (
        ...
        mock_v1_client.read_namespaced_service = AsyncMock()
        mock_v1_client.create_namespaced_service = AsyncMock()
        mock_v1_client.patch_namespaced_service = AsyncMock()
        mock_v1_client.delete_namespaced_service = AsyncMock()
